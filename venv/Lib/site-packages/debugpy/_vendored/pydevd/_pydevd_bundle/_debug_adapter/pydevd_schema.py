...
class Request(BaseSchema):
    ...
    def __init__(self, command, seq=-1, arguments=None, update_ids_from_dap=False,
...
class Event(BaseSchema):
    ...
    def __init__(self, event, seq=-1, body=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string type: 
...
class Response(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, seq=-1, message=None, body=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string type: 
...
class ErrorResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string type: 
        :param integer request_seq: Sequence number of the corresponding request.
        ...
        if body is None:
            ...
            self.body = ErrorResponseBody(update_ids_from_dap=update_ids_from_dap,
                                          **body) if body.__class__ != ErrorResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class CancelRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string type: 
        ...
        if arguments is None:
            ...
            self.arguments = CancelArguments(update_ids_from_dap=update_ids_from_dap,
                                             **arguments) if arguments.__class__ != CancelArguments else arguments
        self.kwargs = kwargs
...
class CancelArguments(BaseSchema):
    ...
    def __init__(self, requestId=None, progressId=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class InitializedEvent(BaseSchema):
    ...
    def __init__(self, seq=-1, body=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string type: 
        :param string event: 
...
class StoppedEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = StoppedEventBody(update_ids_from_dap=update_ids_from_dap,
                                         **body) if body.__class__ != StoppedEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class ContinuedEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = ContinuedEventBody(update_ids_from_dap=update_ids_from_dap,
                                           **body) if body.__class__ != ContinuedEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class ExitedEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = ExitedEventBody(update_ids_from_dap=update_ids_from_dap,
                                        **body) if body.__class__ != ExitedEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class TerminatedEvent(BaseSchema):
    ...
    def __init__(self, seq=-1, body=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = TerminatedEventBody(update_ids_from_dap=update_ids_from_dap,
                                            **body) if body.__class__ != TerminatedEventBody else body
        self.kwargs = kwargs
...
class ThreadEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = ThreadEventBody(update_ids_from_dap=update_ids_from_dap,
                                        **body) if body.__class__ != ThreadEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class OutputEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = OutputEventBody(update_ids_from_dap=update_ids_from_dap,
                                        **body) if body.__class__ != OutputEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class BreakpointEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = BreakpointEventBody(update_ids_from_dap=update_ids_from_dap,
                                            **body) if body.__class__ != BreakpointEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class ModuleEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = ModuleEventBody(update_ids_from_dap=update_ids_from_dap,
                                        **body) if body.__class__ != ModuleEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class LoadedSourceEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = LoadedSourceEventBody(update_ids_from_dap=update_ids_from_dap,
                                              **body) if body.__class__ != LoadedSourceEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class ProcessEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = ProcessEventBody(update_ids_from_dap=update_ids_from_dap,
                                         **body) if body.__class__ != ProcessEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class CapabilitiesEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = CapabilitiesEventBody(update_ids_from_dap=update_ids_from_dap,
                                              **body) if body.__class__ != CapabilitiesEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class ProgressStartEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = ProgressStartEventBody(update_ids_from_dap=update_ids_from_dap,
                                               **body) if body.__class__ != ProgressStartEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class ProgressUpdateEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = ProgressUpdateEventBody(update_ids_from_dap=update_ids_from_dap,
                                                **body) if body.__class__ != ProgressUpdateEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class ProgressEndEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = ProgressEndEventBody(update_ids_from_dap=update_ids_from_dap,
                                             **body) if body.__class__ != ProgressEndEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class InvalidatedEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = InvalidatedEventBody(update_ids_from_dap=update_ids_from_dap,
                                             **body) if body.__class__ != InvalidatedEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class MemoryEvent(BaseSchema):
    ...
    def __init__(self, body, seq=-1, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if body is None:
            ...
            self.body = MemoryEventBody(update_ids_from_dap=update_ids_from_dap,
                                        **body) if body.__class__ != MemoryEventBody else body
        self.seq = seq
        self.kwargs = kwargs
...
class RunInTerminalRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string type: 
        :param string command: 
        ...
        if arguments is None:
            ...
            self.arguments = RunInTerminalRequestArguments(update_ids_from_dap=update_ids_from_dap,
                                                           **arguments) if arguments.__class__ != RunInTerminalRequestArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class RunInTerminalRequestArguments(BaseSchema):
    ...
    def __init__(self, cwd, args, kind=None, title=None, env=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if env is None:
            ...
            self.env = RunInTerminalRequestArgumentsEnv(update_ids_from_dap=update_ids_from_dap,
                                                        **env) if env.__class__ != RunInTerminalRequestArgumentsEnv else env
        self.kwargs = kwargs
...
class RunInTerminalResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = RunInTerminalResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                  **body) if body.__class__ != RunInTerminalResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class InitializeRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = InitializeRequestArguments(update_ids_from_dap=update_ids_from_dap,
                                                        **arguments) if arguments.__class__ != InitializeRequestArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class InitializeRequestArguments(BaseSchema):
    ...
    def __init__(self, adapterID, clientID=None, clientName=None, locale=None, linesStartAt1=None, columnsStartAt1=None,
                 pathFormat=None, supportsVariableType=None, supportsVariablePaging=None,
                 supportsRunInTerminalRequest=None, supportsMemoryReferences=None, supportsProgressReporting=None,
                 supportsInvalidatedEvent=None, supportsMemoryEvent=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class InitializeResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, seq=-1, message=None, body=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = Capabilities(update_ids_from_dap=update_ids_from_dap,
                                     **body) if body.__class__ != Capabilities else body
        self.kwargs = kwargs
...
class ConfigurationDoneRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = ConfigurationDoneArguments(update_ids_from_dap=update_ids_from_dap,
                                                        **arguments) if arguments.__class__ != ConfigurationDoneArguments else arguments
        self.kwargs = kwargs
...
class LaunchRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = LaunchRequestArguments(update_ids_from_dap=update_ids_from_dap,
                                                    **arguments) if arguments.__class__ != LaunchRequestArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class LaunchRequestArguments(BaseSchema):
    ...
    def __init__(self, noDebug=None, __restart=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class AttachRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = AttachRequestArguments(update_ids_from_dap=update_ids_from_dap,
                                                    **arguments) if arguments.__class__ != AttachRequestArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class RestartRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = RestartArguments(update_ids_from_dap=update_ids_from_dap,
                                              **arguments) if arguments.__class__ != RestartArguments else arguments
        self.kwargs = kwargs
...
class DisconnectRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = DisconnectArguments(update_ids_from_dap=update_ids_from_dap,
                                                 **arguments) if arguments.__class__ != DisconnectArguments else arguments
        self.kwargs = kwargs
...
class DisconnectArguments(BaseSchema):
    ...
    def __init__(self, restart=None, terminateDebuggee=None, suspendDebuggee=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class TerminateRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = TerminateArguments(update_ids_from_dap=update_ids_from_dap,
                                                **arguments) if arguments.__class__ != TerminateArguments else arguments
        self.kwargs = kwargs
...
class BreakpointLocationsRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = BreakpointLocationsArguments(update_ids_from_dap=update_ids_from_dap,
                                                          **arguments) if arguments.__class__ != BreakpointLocationsArguments else arguments
        self.kwargs = kwargs
...
class BreakpointLocationsArguments(BaseSchema):
    ...
    def __init__(self, source, line, column=None, endLine=None, endColumn=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if source is None:
            ...
            self.source = Source(update_ids_from_dap=update_ids_from_dap,
                                 **source) if source.__class__ != Source else source
        self.line = line
        self.column = column
...
class BreakpointLocationsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = BreakpointLocationsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                        **body) if body.__class__ != BreakpointLocationsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class SetBreakpointsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetBreakpointsArguments(update_ids_from_dap=update_ids_from_dap,
                                                     **arguments) if arguments.__class__ != SetBreakpointsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetBreakpointsArguments(BaseSchema):
    ...
    def __init__(self, source, breakpoints=None, lines=None, sourceModified=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param Source source: The source location of the breakpoints; either 'source.path' or 'source.reference' must be specified.
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if breakpoints is not None:
            dct['breakpoints'] = [SourceBreakpoint.update_dict_ids_to_dap(o) for o in breakpoints] if (
                        update_ids_to_dap and breakpoints) else breakpoints
...
class SetBreakpointsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = SetBreakpointsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                   **body) if body.__class__ != SetBreakpointsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class SetFunctionBreakpointsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetFunctionBreakpointsArguments(update_ids_from_dap=update_ids_from_dap,
                                                             **arguments) if arguments.__class__ != SetFunctionBreakpointsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetFunctionBreakpointsArguments(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if breakpoints and hasattr(breakpoints[0], "to_dict"):
            breakpoints = [x.to_dict() for x in breakpoints]
        dct = {
            'breakpoints': [FunctionBreakpoint.update_dict_ids_to_dap(o) for o in breakpoints] if (
                        update_ids_to_dap and breakpoints) else breakpoints,
        }
        dct.update(self.kwargs)
        return dct
...
class SetFunctionBreakpointsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = SetFunctionBreakpointsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                           **body) if body.__class__ != SetFunctionBreakpointsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class SetExceptionBreakpointsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetExceptionBreakpointsArguments(update_ids_from_dap=update_ids_from_dap,
                                                              **arguments) if arguments.__class__ != SetExceptionBreakpointsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetExceptionBreakpointsArguments(BaseSchema):
    ...
    def __init__(self, filters, filterOptions=None, exceptionOptions=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if filterOptions is not None:
            dct['filterOptions'] = [ExceptionFilterOptions.update_dict_ids_to_dap(o) for o in filterOptions] if (
                        update_ids_to_dap and filterOptions) else filterOptions
        if exceptionOptions is not None:
            dct['exceptionOptions'] = [ExceptionOptions.update_dict_ids_to_dap(o) for o in exceptionOptions] if (
                        update_ids_to_dap and exceptionOptions) else exceptionOptions
        dct.update(self.kwargs)
        return dct
...
class SetExceptionBreakpointsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, seq=-1, message=None, body=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = SetExceptionBreakpointsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                            **body) if body.__class__ != SetExceptionBreakpointsResponseBody else body
        self.kwargs = kwargs
...
class DataBreakpointInfoRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = DataBreakpointInfoArguments(update_ids_from_dap=update_ids_from_dap,
                                                         **arguments) if arguments.__class__ != DataBreakpointInfoArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class DataBreakpointInfoArguments(BaseSchema):
    ...
    def __init__(self, name, variablesReference=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class DataBreakpointInfoResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = DataBreakpointInfoResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                       **body) if body.__class__ != DataBreakpointInfoResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class SetDataBreakpointsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetDataBreakpointsArguments(update_ids_from_dap=update_ids_from_dap,
                                                         **arguments) if arguments.__class__ != SetDataBreakpointsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetDataBreakpointsArguments(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if breakpoints and hasattr(breakpoints[0], "to_dict"):
            breakpoints = [x.to_dict() for x in breakpoints]
        dct = {
            'breakpoints': [DataBreakpoint.update_dict_ids_to_dap(o) for o in breakpoints] if (
                        update_ids_to_dap and breakpoints) else breakpoints,
        }
        dct.update(self.kwargs)
        return dct
...
class SetDataBreakpointsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = SetDataBreakpointsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                       **body) if body.__class__ != SetDataBreakpointsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class SetInstructionBreakpointsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetInstructionBreakpointsArguments(update_ids_from_dap=update_ids_from_dap,
                                                                **arguments) if arguments.__class__ != SetInstructionBreakpointsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetInstructionBreakpointsArguments(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if breakpoints and hasattr(breakpoints[0], "to_dict"):
            breakpoints = [x.to_dict() for x in breakpoints]
        dct = {
            'breakpoints': [InstructionBreakpoint.update_dict_ids_to_dap(o) for o in breakpoints] if (
                        update_ids_to_dap and breakpoints) else breakpoints,
        }
        dct.update(self.kwargs)
        return dct
...
class SetInstructionBreakpointsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = SetInstructionBreakpointsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                              **body) if body.__class__ != SetInstructionBreakpointsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class ContinueRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = ContinueArguments(update_ids_from_dap=update_ids_from_dap,
                                               **arguments) if arguments.__class__ != ContinueArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class ContinueArguments(BaseSchema):
    ...
    def __init__(self, threadId, singleThread=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ContinueResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = ContinueResponseBody(update_ids_from_dap=update_ids_from_dap,
                                             **body) if body.__class__ != ContinueResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class NextRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = NextArguments(update_ids_from_dap=update_ids_from_dap,
                                           **arguments) if arguments.__class__ != NextArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class NextArguments(BaseSchema):
    ...
    def __init__(self, threadId, singleThread=None, granularity=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class StepInRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = StepInArguments(update_ids_from_dap=update_ids_from_dap,
                                             **arguments) if arguments.__class__ != StepInArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class StepInArguments(BaseSchema):
    ...
    def __init__(self, threadId, singleThread=None, targetId=None, granularity=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class StepOutRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = StepOutArguments(update_ids_from_dap=update_ids_from_dap,
                                              **arguments) if arguments.__class__ != StepOutArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class StepBackRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = StepBackArguments(update_ids_from_dap=update_ids_from_dap,
                                               **arguments) if arguments.__class__ != StepBackArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class ReverseContinueRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = ReverseContinueArguments(update_ids_from_dap=update_ids_from_dap,
                                                      **arguments) if arguments.__class__ != ReverseContinueArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class RestartFrameRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = RestartFrameArguments(update_ids_from_dap=update_ids_from_dap,
                                                   **arguments) if arguments.__class__ != RestartFrameArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class GotoRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = GotoArguments(update_ids_from_dap=update_ids_from_dap,
                                           **arguments) if arguments.__class__ != GotoArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class GotoArguments(BaseSchema):
    ...
    def __init__(self, threadId, targetId, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class PauseRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = PauseArguments(update_ids_from_dap=update_ids_from_dap,
                                            **arguments) if arguments.__class__ != PauseArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class StackTraceRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = StackTraceArguments(update_ids_from_dap=update_ids_from_dap,
                                                 **arguments) if arguments.__class__ != StackTraceArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class StackTraceArguments(BaseSchema):
    ...
    def __init__(self, threadId, startFrame=None, levels=None, format=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if format is None:
            ...
            self.format = StackFrameFormat(update_ids_from_dap=update_ids_from_dap,
                                           **format) if format.__class__ != StackFrameFormat else format
        if update_ids_from_dap:
            self.threadId = self._translate_id_from_dap(self.threadId)
        self.kwargs = kwargs
...
class StackTraceResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = StackTraceResponseBody(update_ids_from_dap=update_ids_from_dap,
                                               **body) if body.__class__ != StackTraceResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class ScopesRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = ScopesArguments(update_ids_from_dap=update_ids_from_dap,
                                             **arguments) if arguments.__class__ != ScopesArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class ScopesResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = ScopesResponseBody(update_ids_from_dap=update_ids_from_dap,
                                           **body) if body.__class__ != ScopesResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class VariablesRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = VariablesArguments(update_ids_from_dap=update_ids_from_dap,
                                                **arguments) if arguments.__class__ != VariablesArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class VariablesArguments(BaseSchema):
    ...
    def __init__(self, variablesReference, filter=None, start=None, count=None, format=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if format is None:
            ...
            self.format = ValueFormat(update_ids_from_dap=update_ids_from_dap,
                                      **format) if format.__class__ != ValueFormat else format
        if update_ids_from_dap:
            self.variablesReference = self._translate_id_from_dap(self.variablesReference)
        self.kwargs = kwargs
...
class VariablesResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = VariablesResponseBody(update_ids_from_dap=update_ids_from_dap,
                                              **body) if body.__class__ != VariablesResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class SetVariableRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetVariableArguments(update_ids_from_dap=update_ids_from_dap,
                                                  **arguments) if arguments.__class__ != SetVariableArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetVariableArguments(BaseSchema):
    ...
    def __init__(self, variablesReference, name, value, format=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class SetVariableResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = SetVariableResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                **body) if body.__class__ != SetVariableResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class SourceRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SourceArguments(update_ids_from_dap=update_ids_from_dap,
                                             **arguments) if arguments.__class__ != SourceArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SourceArguments(BaseSchema):
    ...
    def __init__(self, sourceReference, source=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class SourceResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = SourceResponseBody(update_ids_from_dap=update_ids_from_dap,
                                           **body) if body.__class__ != SourceResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class ThreadsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = ThreadsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                            **body) if body.__class__ != ThreadsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class TerminateThreadsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = TerminateThreadsArguments(update_ids_from_dap=update_ids_from_dap,
                                                       **arguments) if arguments.__class__ != TerminateThreadsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class ModulesRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = ModulesArguments(update_ids_from_dap=update_ids_from_dap,
                                              **arguments) if arguments.__class__ != ModulesArguments else arguments
        self.kwargs = kwargs
...
class ModulesArguments(BaseSchema):
    ...
    def __init__(self, startModule=None, moduleCount=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ModulesResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = ModulesResponseBody(update_ids_from_dap=update_ids_from_dap,
                                            **body) if body.__class__ != ModulesResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class LoadedSourcesRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = LoadedSourcesArguments(update_ids_from_dap=update_ids_from_dap,
                                                    **arguments) if arguments.__class__ != LoadedSourcesArguments else arguments
        self.kwargs = kwargs
...
class LoadedSourcesResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = LoadedSourcesResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                  **body) if body.__class__ != LoadedSourcesResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class EvaluateRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = EvaluateArguments(update_ids_from_dap=update_ids_from_dap,
                                               **arguments) if arguments.__class__ != EvaluateArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class EvaluateArguments(BaseSchema):
    ...
    def __init__(self, expression, frameId=None, context=None, format=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class EvaluateResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = EvaluateResponseBody(update_ids_from_dap=update_ids_from_dap,
                                             **body) if body.__class__ != EvaluateResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class SetExpressionRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetExpressionArguments(update_ids_from_dap=update_ids_from_dap,
                                                    **arguments) if arguments.__class__ != SetExpressionArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetExpressionArguments(BaseSchema):
    ...
    def __init__(self, expression, value, frameId=None, format=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class SetExpressionResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = SetExpressionResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                  **body) if body.__class__ != SetExpressionResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class StepInTargetsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = StepInTargetsArguments(update_ids_from_dap=update_ids_from_dap,
                                                    **arguments) if arguments.__class__ != StepInTargetsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class StepInTargetsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = StepInTargetsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                  **body) if body.__class__ != StepInTargetsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class GotoTargetsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = GotoTargetsArguments(update_ids_from_dap=update_ids_from_dap,
                                                  **arguments) if arguments.__class__ != GotoTargetsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class GotoTargetsArguments(BaseSchema):
    ...
    def __init__(self, source, line, column=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class GotoTargetsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = GotoTargetsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                **body) if body.__class__ != GotoTargetsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class CompletionsRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = CompletionsArguments(update_ids_from_dap=update_ids_from_dap,
                                                  **arguments) if arguments.__class__ != CompletionsArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class CompletionsArguments(BaseSchema):
    ...
    def __init__(self, text, column, frameId=None, line=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class CompletionsResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = CompletionsResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                **body) if body.__class__ != CompletionsResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class ExceptionInfoRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = ExceptionInfoArguments(update_ids_from_dap=update_ids_from_dap,
                                                    **arguments) if arguments.__class__ != ExceptionInfoArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class ExceptionInfoResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = ExceptionInfoResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                  **body) if body.__class__ != ExceptionInfoResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class ReadMemoryRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = ReadMemoryArguments(update_ids_from_dap=update_ids_from_dap,
                                                 **arguments) if arguments.__class__ != ReadMemoryArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class ReadMemoryArguments(BaseSchema):
    ...
    def __init__(self, memoryReference, count, offset=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ReadMemoryResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, seq=-1, message=None, body=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = ReadMemoryResponseBody(update_ids_from_dap=update_ids_from_dap,
                                               **body) if body.__class__ != ReadMemoryResponseBody else body
        self.kwargs = kwargs
...
class WriteMemoryRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = WriteMemoryArguments(update_ids_from_dap=update_ids_from_dap,
                                                  **arguments) if arguments.__class__ != WriteMemoryArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class WriteMemoryArguments(BaseSchema):
    ...
    def __init__(self, memoryReference, data, offset=None, allowPartial=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class WriteMemoryResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, seq=-1, message=None, body=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = WriteMemoryResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                **body) if body.__class__ != WriteMemoryResponseBody else body
        self.kwargs = kwargs
...
class DisassembleRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = DisassembleArguments(update_ids_from_dap=update_ids_from_dap,
                                                  **arguments) if arguments.__class__ != DisassembleArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class DisassembleArguments(BaseSchema):
    ...
    def __init__(self, memoryReference, instructionCount, offset=None, instructionOffset=None, resolveSymbols=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class DisassembleResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, seq=-1, message=None, body=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = DisassembleResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                **body) if body.__class__ != DisassembleResponseBody else body
        self.kwargs = kwargs
...
class Capabilities(BaseSchema):
    ...
    def __init__(self, supportsConfigurationDoneRequest=None, supportsFunctionBreakpoints=None,
                 supportsConditionalBreakpoints=None, supportsHitConditionalBreakpoints=None,
                 supportsEvaluateForHovers=None, exceptionBreakpointFilters=None, supportsStepBack=None,
                 supportsSetVariable=None, supportsRestartFrame=None, supportsGotoTargetsRequest=None,
                 supportsStepInTargetsRequest=None, supportsCompletionsRequest=None, completionTriggerCharacters=None,
                 supportsModulesRequest=None, additionalModuleColumns=None, supportedChecksumAlgorithms=None,
                 supportsRestartRequest=None, supportsExceptionOptions=None, supportsValueFormattingOptions=None,
                 supportsExceptionInfoRequest=None, supportTerminateDebuggee=None, supportSuspendDebuggee=None,
                 supportsDelayedStackTraceLoading=None, supportsLoadedSourcesRequest=None, supportsLogPoints=None,
                 supportsTerminateThreadsRequest=None, supportsSetExpression=None, supportsTerminateRequest=None,
                 supportsDataBreakpoints=None, supportsReadMemoryRequest=None, supportsWriteMemoryRequest=None,
                 supportsDisassembleRequest=None, supportsCancelRequest=None, supportsBreakpointLocationsRequest=None,
                 supportsClipboardContext=None, supportsSteppingGranularity=None, supportsInstructionBreakpoints=None,
                 supportsExceptionFilterOptions=None, supportsSingleThreadExecutionRequests=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if exceptionBreakpointFilters is not None:
            dct['exceptionBreakpointFilters'] = [ExceptionBreakpointsFilter.update_dict_ids_to_dap(o) for o in
                                                 exceptionBreakpointFilters] if (
                        update_ids_to_dap and exceptionBreakpointFilters) else exceptionBreakpointFilters
        ...
        if additionalModuleColumns is not None:
            dct['additionalModuleColumns'] = [ColumnDescriptor.update_dict_ids_to_dap(o) for o in
                                              additionalModuleColumns] if (
                        update_ids_to_dap and additionalModuleColumns) else additionalModuleColumns
        if supportedChecksumAlgorithms is not None:
            dct['supportedChecksumAlgorithms'] = [ChecksumAlgorithm.update_dict_ids_to_dap(o) for o in
                                                  supportedChecksumAlgorithms] if (
                        update_ids_to_dap and supportedChecksumAlgorithms) else supportedChecksumAlgorithms
...
class ExceptionBreakpointsFilter(BaseSchema):
    ...
    def __init__(self, filter, label, description=None, default=None, supportsCondition=None, conditionDescription=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class Message(BaseSchema):
    ...
    def __init__(self, id, format, variables=None, sendTelemetry=None, showUser=None, url=None, urlLabel=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if variables is None:
            ...
            self.variables = MessageVariables(update_ids_from_dap=update_ids_from_dap,
                                              **variables) if variables.__class__ != MessageVariables else variables
...
class Module(BaseSchema):
    ...
    def __init__(self, id, name, path=None, isOptimized=None, isUserCode=None, version=None, symbolStatus=None,
                 symbolFilePath=None, dateTimeStamp=None, addressRange=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ColumnDescriptor(BaseSchema):
    ...
    def __init__(self, attributeName, label, format=None, type=None, width=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ModulesViewDescriptor(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        dct = {
            'columns': [ColumnDescriptor.update_dict_ids_to_dap(o) for o in columns] if (
                        update_ids_to_dap and columns) else columns,
        }
        dct.update(self.kwargs)
        return dct
...
class Source(BaseSchema):
    ...
    def __init__(self, name=None, path=None, sourceReference=None, presentationHint=None, origin=None, sources=None,
                 adapterData=None, checksums=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if sources is not None:
            dct['sources'] = [Source.update_dict_ids_to_dap(o) for o in sources] if (
                        update_ids_to_dap and sources) else sources
        if adapterData is not None:
            dct['adapterData'] = adapterData
        if checksums is not None:
            dct['checksums'] = [Checksum.update_dict_ids_to_dap(o) for o in checksums] if (
                        update_ids_to_dap and checksums) else checksums
        dct.update(self.kwargs)
        return dct
...
class StackFrame(BaseSchema):
    ...
    def __init__(self, id, name, line, column, source=None, endLine=None, endColumn=None, canRestart=None,
                 instructionPointerReference=None, moduleId=None, presentationHint=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class Scope(BaseSchema):
    ...
    def __init__(self, name, variablesReference, expensive, presentationHint=None, namedVariables=None,
                 indexedVariables=None, source=None, line=None, column=None, endLine=None, endColumn=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class Variable(BaseSchema):
    ...
    def __init__(self, name, value, variablesReference, type=None, presentationHint=None, evaluateName=None,
                 namedVariables=None, indexedVariables=None, memoryReference=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if presentationHint is None:
            ...
            self.presentationHint = VariablePresentationHint(update_ids_from_dap=update_ids_from_dap,
                                                             **presentationHint) if presentationHint.__class__ != VariablePresentationHint else presentationHint
...
class VariablePresentationHint(BaseSchema):
    ...
    def __init__(self, kind=None, attributes=None, visibility=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class BreakpointLocation(BaseSchema):
    ...
    def __init__(self, line, column=None, endLine=None, endColumn=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class SourceBreakpoint(BaseSchema):
    ...
    def __init__(self, line, column=None, condition=None, hitCondition=None, logMessage=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class FunctionBreakpoint(BaseSchema):
    ...
    def __init__(self, name, condition=None, hitCondition=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class DataBreakpoint(BaseSchema):
    ...
    def __init__(self, dataId, accessType=None, condition=None, hitCondition=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class InstructionBreakpoint(BaseSchema):
    ...
    def __init__(self, instructionReference, offset=None, condition=None, hitCondition=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class Breakpoint(BaseSchema):
    ...
    def __init__(self, verified, id=None, message=None, source=None, line=None, column=None, endLine=None,
                 endColumn=None, instructionReference=None, offset=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class GotoTarget(BaseSchema):
    ...
    def __init__(self, id, label, line, column=None, endLine=None, endColumn=None, instructionPointerReference=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class CompletionItem(BaseSchema):
    ...
    def __init__(self, label, text=None, sortText=None, type=None, start=None, length=None, selectionStart=None,
                 selectionLength=None, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class CompletionItemType(BaseSchema):
    ...
    VALID_VALUES = set(
        ['method', 'function', 'constructor', 'field', 'variable', 'class', 'interface', 'module', 'property', 'unit',
...
class Checksum(BaseSchema):
    ...
    def __init__(self, algorithm, checksum, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class StackFrameFormat(BaseSchema):
    ...
    def __init__(self, hex=None, parameters=None, parameterTypes=None, parameterNames=None, parameterValues=None,
                 line=None, module=None, includeAll=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param boolean hex: Display the value in hex.
...
class ExceptionFilterOptions(BaseSchema):
    ...
    def __init__(self, filterId, condition=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ExceptionOptions(BaseSchema):
    ...
    def __init__(self, breakMode, path=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if path is not None:
            dct['path'] = [ExceptionPathSegment.update_dict_ids_to_dap(o) for o in path] if (
                        update_ids_to_dap and path) else path
        dct.update(self.kwargs)
        return dct
...
class ExceptionPathSegment(BaseSchema):
    ...
    def __init__(self, names, negate=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ExceptionDetails(BaseSchema):
    ...
    def __init__(self, message=None, typeName=None, fullTypeName=None, evaluateName=None, stackTrace=None,
                 innerException=None, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if innerException is not None:
            dct['innerException'] = [ExceptionDetails.update_dict_ids_to_dap(o) for o in innerException] if (
                        update_ids_to_dap and innerException) else innerException
        dct.update(self.kwargs)
        return dct
...
class DisassembledInstruction(BaseSchema):
    ...
    def __init__(self, address, instruction, instructionBytes=None, symbol=None, location=None, line=None, column=None,
                 endLine=None, endColumn=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if location is None:
            ...
            self.location = Source(update_ids_from_dap=update_ids_from_dap,
                                   **location) if location.__class__ != Source else location
        self.line = line
        self.column = column
        self.endLine = endLine
        self.endColumn = endColumn
...
class SetDebuggerPropertyRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetDebuggerPropertyArguments(update_ids_from_dap=update_ids_from_dap,
                                                          **arguments) if arguments.__class__ != SetDebuggerPropertyArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetDebuggerPropertyArguments(BaseSchema):
    ...
    def __init__(self, ideOS=None, dontTraceStartPatterns=None, dontTraceEndPatterns=None,
                 skipSuspendOnBreakpointException=None, skipPrintBreakpointException=None,
                 multiThreadsSingleNotification=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class SetPydevdSourceMapRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = SetPydevdSourceMapArguments(update_ids_from_dap=update_ids_from_dap,
                                                         **arguments) if arguments.__class__ != SetPydevdSourceMapArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class SetPydevdSourceMapArguments(BaseSchema):
    ...
    def __init__(self, source, pydevdSourceMaps=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if pydevdSourceMaps is not None:
            dct['pydevdSourceMaps'] = [PydevdSourceMap.update_dict_ids_to_dap(o) for o in pydevdSourceMaps] if (
                        update_ids_to_dap and pydevdSourceMaps) else pydevdSourceMaps
        dct.update(self.kwargs)
        return dct
...
class PydevdSourceMap(BaseSchema):
    ...
    def __init__(self, line, endLine, runtimeSource, runtimeLine, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if runtimeSource is None:
            ...
            self.runtimeSource = Source(update_ids_from_dap=update_ids_from_dap,
                                        **runtimeSource) if runtimeSource.__class__ != Source else runtimeSource
...
class PydevdSystemInfoRequest(BaseSchema):
    ...
    def __init__(self, seq=-1, arguments=None, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = PydevdSystemInfoArguments(update_ids_from_dap=update_ids_from_dap,
                                                       **arguments) if arguments.__class__ != PydevdSystemInfoArguments else arguments
        self.kwargs = kwargs
...
class PydevdSystemInfoResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = PydevdSystemInfoResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                     **body) if body.__class__ != PydevdSystemInfoResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class PydevdPythonInfo(BaseSchema):
    ...
    def __init__(self, version=None, implementation=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if implementation is None:
            ...
            self.implementation = PydevdPythonImplementationInfo(update_ids_from_dap=update_ids_from_dap,
                                                                 **implementation) if implementation.__class__ != PydevdPythonImplementationInfo else implementation
        self.kwargs = kwargs
...
class PydevdPythonImplementationInfo(BaseSchema):
    ...
    def __init__(self, name=None, version=None, description=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class PydevdProcessInfo(BaseSchema):
    ...
    def __init__(self, pid=None, ppid=None, executable=None, bitness=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class PydevdInfo(BaseSchema):
    ...
    def __init__(self, usingCython=None, usingFrameEval=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class PydevdAuthorizeRequest(BaseSchema):
    ...
    def __init__(self, arguments, seq=-1, update_ids_from_dap=False,
        ...
        if arguments is None:
            ...
            self.arguments = PydevdAuthorizeArguments(update_ids_from_dap=update_ids_from_dap,
                                                      **arguments) if arguments.__class__ != PydevdAuthorizeArguments else arguments
        self.seq = seq
        self.kwargs = kwargs
...
class PydevdAuthorizeArguments(BaseSchema):
    ...
    def __init__(self, debugServerAccessToken=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class PydevdAuthorizeResponse(BaseSchema):
    ...
    def __init__(self, request_seq, success, command, body, seq=-1, message=None, update_ids_from_dap=False,
        ...
        if body is None:
            ...
            self.body = PydevdAuthorizeResponseBody(update_ids_from_dap=update_ids_from_dap,
                                                    **body) if body.__class__ != PydevdAuthorizeResponseBody else body
        self.seq = seq
        self.message = message
        self.kwargs = kwargs
...
class ErrorResponseBody(BaseSchema):
    ...
    def __init__(self, error=None, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if error is None:
            ...
            self.error = Message(update_ids_from_dap=update_ids_from_dap,
                                 **error) if error.__class__ != Message else error
        self.kwargs = kwargs
...
class StoppedEventBody(BaseSchema):
    ...
    def __init__(self, reason, description=None, threadId=None, preserveFocusHint=None, text=None,
                 allThreadsStopped=None, hitBreakpointIds=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ContinuedEventBody(BaseSchema):
    ...
    def __init__(self, threadId, allThreadsContinued=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ThreadEventBody(BaseSchema):
    ...
    def __init__(self, reason, threadId, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string reason: The reason for the event.
...
class OutputEventBody(BaseSchema):
    ...
    def __init__(self, output, category=None, group=None, variablesReference=None, source=None, line=None, column=None,
                 data=None, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class BreakpointEventBody(BaseSchema):
    ...
    def __init__(self, reason, breakpoint, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string reason: The reason for the event.
        ...
        if breakpoint is None:
            ...
            self.breakpoint = Breakpoint(update_ids_from_dap=update_ids_from_dap,
                                         **breakpoint) if breakpoint.__class__ != Breakpoint else breakpoint
        self.kwargs = kwargs
...
class ModuleEventBody(BaseSchema):
    ...
    def __init__(self, reason, module, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if module is None:
            ...
            self.module = Module(update_ids_from_dap=update_ids_from_dap,
                                 **module) if module.__class__ != Module else module
        self.kwargs = kwargs
...
class ProcessEventBody(BaseSchema):
    ...
    def __init__(self, name, systemProcessId=None, isLocalProcess=None, startMethod=None, pointerSize=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class CapabilitiesEventBody(BaseSchema):
    ...
    def __init__(self, capabilities, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        if capabilities is None:
            ...
            self.capabilities = Capabilities(update_ids_from_dap=update_ids_from_dap,
                                             **capabilities) if capabilities.__class__ != Capabilities else capabilities
        self.kwargs = kwargs
...
class ProgressStartEventBody(BaseSchema):
    ...
    def __init__(self, progressId, title, requestId=None, cancellable=None, message=None, percentage=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ProgressUpdateEventBody(BaseSchema):
    ...
    def __init__(self, progressId, message=None, percentage=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ProgressEndEventBody(BaseSchema):
    ...
    def __init__(self, progressId, message=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class InvalidatedEventBody(BaseSchema):
    ...
    def __init__(self, areas=None, threadId=None, stackFrameId=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if areas is not None:
            dct['areas'] = [InvalidatedAreas.update_dict_ids_to_dap(o) for o in areas] if (
                        update_ids_to_dap and areas) else areas
        if threadId is not None:
            dct['threadId'] = threadId
...
class MemoryEventBody(BaseSchema):
    ...
    def __init__(self, memoryReference, offset, count, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class RunInTerminalResponseBody(BaseSchema):
    ...
    def __init__(self, processId=None, shellProcessId=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class BreakpointLocationsResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if breakpoints and hasattr(breakpoints[0], "to_dict"):
            breakpoints = [x.to_dict() for x in breakpoints]
        dct = {
            'breakpoints': [BreakpointLocation.update_dict_ids_to_dap(o) for o in breakpoints] if (
                        update_ids_to_dap and breakpoints) else breakpoints,
        }
        dct.update(self.kwargs)
        return dct
...
class SetBreakpointsResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if breakpoints and hasattr(breakpoints[0], "to_dict"):
            breakpoints = [x.to_dict() for x in breakpoints]
        dct = {
            'breakpoints': [Breakpoint.update_dict_ids_to_dap(o) for o in breakpoints] if (
                        update_ids_to_dap and breakpoints) else breakpoints,
        }
        dct.update(self.kwargs)
        return dct
...
class SetExceptionBreakpointsResponseBody(BaseSchema):
    ...
    def __init__(self, breakpoints=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if breakpoints is not None:
            dct['breakpoints'] = [Breakpoint.update_dict_ids_to_dap(o) for o in breakpoints] if (
                        update_ids_to_dap and breakpoints) else breakpoints
        dct.update(self.kwargs)
        return dct
...
class DataBreakpointInfoResponseBody(BaseSchema):
    ...
    def __init__(self, dataId, description, accessTypes=None, canPersist=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if accessTypes is not None:
            dct['accessTypes'] = [DataBreakpointAccessType.update_dict_ids_to_dap(o) for o in accessTypes] if (
                        update_ids_to_dap and accessTypes) else accessTypes
...
class ContinueResponseBody(BaseSchema):
    ...
    def __init__(self, allThreadsContinued=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class StackTraceResponseBody(BaseSchema):
    ...
    def __init__(self, stackFrames, totalFrames=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        dct = {
            'stackFrames': [StackFrame.update_dict_ids_to_dap(o) for o in stackFrames] if (
                        update_ids_to_dap and stackFrames) else stackFrames,
        }
...
class VariablesResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        dct = {
            'variables': [Variable.update_dict_ids_to_dap(o) for o in variables] if (
                        update_ids_to_dap and variables) else variables,
        }
        dct.update(self.kwargs)
        return dct
...
class SetVariableResponseBody(BaseSchema):
    ...
    def __init__(self, value, type=None, variablesReference=None, namedVariables=None, indexedVariables=None,
                 update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class SourceResponseBody(BaseSchema):
    ...
    def __init__(self, content, mimeType=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class ThreadsResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        dct = {
            'threads': [Thread.update_dict_ids_to_dap(o) for o in threads] if (
                        update_ids_to_dap and threads) else threads,
        }
        dct.update(self.kwargs)
        return dct
...
class ModulesResponseBody(BaseSchema):
    ...
    def __init__(self, modules, totalModules=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        dct = {
            'modules': [Module.update_dict_ids_to_dap(o) for o in modules] if (
                        update_ids_to_dap and modules) else modules,
        }
...
class LoadedSourcesResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if sources and hasattr(sources[0], "to_dict"):
            sources = [x.to_dict() for x in sources]
        dct = {
            'sources': [Source.update_dict_ids_to_dap(o) for o in sources] if (
                        update_ids_to_dap and sources) else sources,
        }
        dct.update(self.kwargs)
        return dct
...
class EvaluateResponseBody(BaseSchema):
    ...
    def __init__(self, result, variablesReference, type=None, presentationHint=None, namedVariables=None,
                 indexedVariables=None, memoryReference=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class SetExpressionResponseBody(BaseSchema):
    ...
    def __init__(self, value, type=None, presentationHint=None, variablesReference=None, namedVariables=None,
                 indexedVariables=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class StepInTargetsResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        dct = {
            'targets': [StepInTarget.update_dict_ids_to_dap(o) for o in targets] if (
                        update_ids_to_dap and targets) else targets,
        }
        dct.update(self.kwargs)
        return dct
...
class GotoTargetsResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if targets and hasattr(targets[0], "to_dict"):
            targets = [x.to_dict() for x in targets]
        dct = {
            'targets': [GotoTarget.update_dict_ids_to_dap(o) for o in targets] if (
                        update_ids_to_dap and targets) else targets,
        }
        dct.update(self.kwargs)
        return dct
...
class CompletionsResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        if targets and hasattr(targets[0], "to_dict"):
            targets = [x.to_dict() for x in targets]
        dct = {
            'targets': [CompletionItem.update_dict_ids_to_dap(o) for o in targets] if (
                        update_ids_to_dap and targets) else targets,
        }
        dct.update(self.kwargs)
        return dct
...
class ExceptionInfoResponseBody(BaseSchema):
    ...
    def __init__(self, exceptionId, breakMode, description=None, details=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if details is None:
            ...
            self.details = ExceptionDetails(update_ids_from_dap=update_ids_from_dap,
                                            **details) if details.__class__ != ExceptionDetails else details
        self.kwargs = kwargs
...
class ReadMemoryResponseBody(BaseSchema):
    ...
    def __init__(self, address, unreadableBytes=None, data=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class WriteMemoryResponseBody(BaseSchema):
    ...
    def __init__(self, offset=None, bytesWritten=None, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
...
class DisassembleResponseBody(BaseSchema):
    ...
    def to_dict(self, update_ids_to_dap=False):  # noqa (update_ids_to_dap may be unused)
        ...
        dct = {
            'instructions': [DisassembledInstruction.update_dict_ids_to_dap(o) for o in instructions] if (
                        update_ids_to_dap and instructions) else instructions,
        }
        dct.update(self.kwargs)
        return dct
...
class PydevdSystemInfoResponseBody(BaseSchema):
    ...
    def __init__(self, python, platform, process, pydevd, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        ...
        if python is None:
            ...
            self.python = PydevdPythonInfo(update_ids_from_dap=update_ids_from_dap,
                                           **python) if python.__class__ != PydevdPythonInfo else python
        if platform is None:
            self.platform = PydevdPlatformInfo()
        else:
            self.platform = PydevdPlatformInfo(update_ids_from_dap=update_ids_from_dap,
                                               **platform) if platform.__class__ != PydevdPlatformInfo else platform
        if process is None:
            self.process = PydevdProcessInfo()
        else:
            self.process = PydevdProcessInfo(update_ids_from_dap=update_ids_from_dap,
                                             **process) if process.__class__ != PydevdProcessInfo else process
        if pydevd is None:
            self.pydevd = PydevdInfo()
        else:
            self.pydevd = PydevdInfo(update_ids_from_dap=update_ids_from_dap,
                                     **pydevd) if pydevd.__class__ != PydevdInfo else pydevd
        self.kwargs = kwargs
...
class PydevdAuthorizeResponseBody(BaseSchema):
    ...
    def __init__(self, clientAccessToken, update_ids_from_dap=False,
                 **kwargs):  # noqa (update_ids_from_dap may be unused)
        """

...
if USE_CYTHON_FLAG in ENV_TRUE_LOWER_VALUES:
    ...
    from _pydevd_bundle.pydevd_cython_wrapper import PyDBAdditionalThreadInfo, set_additional_thread_info, \
    ...
    from _pydevd_bundle.pydevd_additional_thread_info_regular import PyDBAdditionalThreadInfo, \
        set_additional_thread_info, _set_additional_thread_info_lock  # @UnusedImport @Reimport
    ...
    try:
        ...
        from _pydevd_bundle.pydevd_additional_thread_info_regular import PyDBAdditionalThreadInfo, \
            set_additional_thread_info, _set_additional_thread_info_lock  # @UnusedImport

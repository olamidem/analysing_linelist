...
from _pydevd_bundle.pydevd_constants import (DebugInfoHolder, IS_WINDOWS, IS_JYTHON,
                                             ...
                                             get_global_debugger, GetGlobalDebugger, set_global_debugger,
...
def build_exception_info_response(dbg, thread_id, request_seq, set_additional_thread_info, iter_visible_frames_info,
                                  max_frames):
    '''
...
def internal_get_exception_details_json(dbg, request, thread_id, max_frames, set_additional_thread_info=None,
                                        iter_visible_frames_info=None):
    ''' Fetch exception details
    '''
    try:
        response = build_exception_info_response(dbg, thread_id, request.seq, set_additional_thread_info,

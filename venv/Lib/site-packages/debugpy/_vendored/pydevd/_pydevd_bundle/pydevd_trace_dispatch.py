...
if USE_CYTHON_FLAG in ENV_TRUE_LOWER_VALUES:
    ...
    from _pydevd_bundle.pydevd_cython_wrapper import trace_dispatch, global_cache_skips, global_cache_frame_skips, \
    ...
    from _pydevd_bundle.pydevd_trace_dispatch_regular import trace_dispatch, global_cache_skips, \
        global_cache_frame_skips, fix_top_level_trace_and_get_trace_func  # @UnusedImport

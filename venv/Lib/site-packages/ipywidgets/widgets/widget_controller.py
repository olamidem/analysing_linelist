...
class Controller(DOMWidget, CoreWidget):
    ...
    buttons = TypedTuple(trait=Instance(Button), read_only=True, help="The buttons on the gamepad.").tag(sync=True,
                                                                                                         **widget_serialization)
    axes = TypedTuple(trait=Instance(Axis), read_only=True, help="The axes on the gamepad.").tag(sync=True,
                                                                                                 **widget_serialization)

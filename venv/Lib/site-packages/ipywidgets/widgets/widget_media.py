...
class Video(_Media):
    ...
    controls = Bool(True,
                    help="Specifies that video controls should be displayed (such as a play/pause button etc)").tag(
        sync=True)
...
class Audio(_Media):
    ...
    controls = Bool(True,
                    help="Specifies that audio controls should be displayed (such as a play/pause button etc)").tag(
        sync=True)

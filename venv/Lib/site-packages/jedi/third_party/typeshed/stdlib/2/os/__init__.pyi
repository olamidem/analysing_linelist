...
from posix import listdir as listdir, \
    stat_result as stat_result  # TODO: use this, see https://github.com/python/mypy/issues/3078
from typing import (
    IO,
    Any,
    AnyStr,
...
if sys.platform == "win32":
    ...
    def spawnlpe(mode: int, file: AnyPath, arg0: Union[bytes, Text], *args: Any) -> int:
        ...  # Imprecise signature

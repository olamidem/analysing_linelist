...
class HTTPRedirectHandler(BaseHandler):
    ...
    def redirect_request(self, req: Request, fp: addinfourl, code: int, msg: str, headers: Mapping[str, str],
                         newurl): ...
...
class HTTPPasswordMgr:
    ...
    def add_password(self, realm: Optional[Text], uri: Union[Text, Sequence[Text]], user: Text,
                     passwd: Text) -> None: ...
...
class AbstractHTTPHandler(BaseHandler):  # undocumented
    ...
    def do_open(self, http_class: HTTPConnectionProtocol, req: Request,

...
class _ActionsContainer:
    ...
    def _handle_conflict_error(self, action: Action,
                               conflicting_actions: Iterable[Tuple[Text, Action]]) -> NoReturn: ...
...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    @overload
    def parse_args(self, args: Optional[Sequence[Text]], namespace: None) -> Namespace:
        ...  # type: ignore
...
class _ArgumentGroup(_ActionsContainer):
    ...
    def __init__(
            self, container: _ActionsContainer, title: Optional[Text] = ..., description: Optional[Text] = ...,
            **kwargs: Any
    ) -> None: ...
...
class _StoreTrueAction(_StoreConstAction):
    def __init__(
            self, option_strings: Sequence[Text], dest: Text, default: bool = ..., required: bool = ...,
            help: Optional[Text] = ...
    ) -> None: ...
...
class _CountAction(Action):
    def __init__(
            self, option_strings: Sequence[Text], dest: Text, default: Any = ..., required: bool = ...,
            help: Optional[Text] = ...
    ) -> None: ...

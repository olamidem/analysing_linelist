...
from typing import Any, BinaryIO, Callable, Dict, Iterable, Iterator, List, Optional, Text, TextIO, Tuple, Type, \
    TypeVar, Union
...
class FTP:
    ...
    def storlines(self, cmd: Text, fp: SupportsReadline[bytes],
                  callback: Optional[Callable[[bytes], Any]] = ...) -> str:
        ...

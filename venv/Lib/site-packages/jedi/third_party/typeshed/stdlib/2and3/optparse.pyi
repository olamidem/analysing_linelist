import sys
from typing import IO, Any, AnyStr, Callable, Dict, Iterable, List, Mapping, Optional, Sequence, Tuple, Type, Union, \
    overload
...
class HelpFormatter:
    ...
    def __init__(self, indent_increment: int, max_help_position: int, width: Optional[int],
...
class IndentedHelpFormatter(HelpFormatter):
    def __init__(
            self, indent_increment: int = ..., max_help_position: int = ..., width: Optional[int] = ...,
            short_first: int = ...
    ) -> None: ...
...
class Option:
    ...
    def take_action(self, action: _Text, dest: _Text, opt: Any, value: Any, values: Any,
                    parser: OptionParser) -> int: ...

...
from typing import Any, Callable, ClassVar, Dict, Iterable, List, NamedTuple, Optional, Set, Text, Tuple, Type, Union, \
    overload
...
def create_default_context(
        purpose: Any = ..., *, cafile: Optional[str] = ..., capath: Optional[str] = ...,
...
class SSLSocket(socket.socket):
    ...
    def do_handshake(self, block: bool = ...) -> None:
        ...  # block is undocumented
...
class SSLContext:
    ...
    def load_verify_locations(
            self, cafile: Optional[StrPath] = ..., capath: Optional[StrPath] = ...,
            cadata: Union[Text, bytes, None] = ...
    ) -> None:
        ...
    ...
    if sys.version_info >= (3, 6):
        ...
        def wrap_bio(
                self, incoming: MemoryBIO, outgoing: MemoryBIO, server_side: bool = ...,
                server_hostname: Optional[str] = ...
        ) -> SSLObject:
            ...

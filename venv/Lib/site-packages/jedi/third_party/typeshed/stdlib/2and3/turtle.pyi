...
class RawTurtle(TPen, TNavigator):
    def __init__(
            self, canvas: Union[Canvas, TurtleScreen, None] = ..., shape: str = ..., undobuffersize: int = ...,
            visible: bool = ...
    ) -> None: ...
    ...
    if sys.version_info >= (3,):
        ...
        @overload
        def shapetransform(
                self, t11: Optional[float] = ..., t12: Optional[float] = ..., t21: Optional[float] = ...,
                t22: Optional[float] = ...
        ) -> None: ...
...
if sys.version_info >= (3,):
    ...
    def numinput(
            title: str, prompt: str, default: Optional[float] = ..., minval: Optional[float] = ...,
            maxval: Optional[float] = ...
    ) -> Optional[float]: ...
...
@overload
def shapesize(stretch_wid: Optional[float] = ..., stretch_len: Optional[float] = ...,
...
if sys.version_info >= (3,):
    ...
    @overload
    def shapetransform(
            t11: Optional[float] = ..., t12: Optional[float] = ..., t21: Optional[float] = ...,
            t22: Optional[float] = ...
    ) -> None: ...

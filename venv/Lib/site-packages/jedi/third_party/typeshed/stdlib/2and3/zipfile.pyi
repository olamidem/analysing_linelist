...
class ZipExtFile(io.BufferedIOBase):
    ...
    if sys.version_info >= (3, 7):
        def __init__(
                self, fileobj: IO[bytes], mode: str, zipinfo: ZipInfo, pwd: Optional[bytes] = ...,
                close_fileobj: bool = ...
        ) -> None:
            ...
    else:
    ...
    def read1(self, n: Optional[int]) -> bytes:
        ...  # type: ignore
...
class ZipFile:
    ...
    if sys.version_info >= (3, 7):
        ...
        def write(self, filename: StrPath, arcname: Optional[StrPath] = ...,
...
class ZipInfo:
    ...
    if sys.version_info >= (3, 8):
        @classmethod
        def from_file(cls, filename: StrPath, arcname: Optional[StrPath] = ..., *,
                      strict_timestamps: bool = ...) -> ZipInfo:
            ...

...
class bytes(ByteString):
    ...
    # Incompatible with Sequence.__contains__
    def __contains__(self, o: Union[int, bytes]) -> bool:
        ...  # type: ignore
...
def eval(
        __source: Union[str, bytes, CodeType], __globals: Optional[Dict[str, Any]] = ...,
...
@overload
def sorted(__iterable: Iterable[SupportsLessThanT], *, key: None = ..., reverse: bool = ...) -> List[
    SupportsLessThanT]: ...

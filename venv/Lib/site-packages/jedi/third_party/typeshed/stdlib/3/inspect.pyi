...
class BlockFinder:
    ...
    def tokeneater(self, type: int, token: str, srowcol: Tuple[int, int], erowcol: Tuple[int, int],
                   line: str) -> None: ...
...
class Signature:
    ...
    def replace(self, *, parameters: Optional[Sequence[Parameter]] = ...,
...
class Parameter:
    ...
    def replace(
            self, *, name: Optional[str] = ..., kind: Optional[_ParameterKind] = ..., default: Any = ...,
            annotation: Any = ...
    ) -> Parameter: ...

...
def Barrier(parties: int, action: Optional[Callable[..., Any]] = ...,
...
# for rationale
def Array(typecode_or_type: Any, size_or_initializer: Union[int, Sequence[Any]], *,
          lock: bool = ...) -> sharedctypes._Array: ...

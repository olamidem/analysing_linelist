...
class Token(object):
    ...
    def __init__(
            self, typeid: Optional[Union[bytes, str]], address: Tuple[Union[str, bytes], int],
            id: Optional[Union[str, bytes, int]]
    ) -> None: ...
    ...
    def __setstate__(
            self,
            state: Tuple[Optional[Union[str, bytes]], Tuple[Union[str, bytes], int], Optional[Union[str, bytes, int]]]
    ) -> None: ...

...
class _Value:
    ...
    def __init__(self, typecode_or_type: Union[str, Type[_CData]], *args: Any,
                 lock: Union[bool, _LockLike] = ...) -> None: ...
...
def Value(
        typecode_or_type: Union[str, Type[_CData]], *args: Any, lock: Union[bool, _LockLike] = ...,
        ctx: Optional[BaseContext] = ...
) -> _Value: ...

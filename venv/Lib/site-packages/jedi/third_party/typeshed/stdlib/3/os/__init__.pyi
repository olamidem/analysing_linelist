...
def access(
        path: _FdOrAnyPath, mode: int, *, dir_fd: Optional[int] = ..., effective_ids: bool = ...,
...
def replace(src: AnyPath, dst: AnyPath, *, src_dir_fd: Optional[int] = ...,
...
def walk(
        top: Union[AnyStr, PathLike[AnyStr]], topdown: bool = ..., onerror: Optional[_OnError] = ...,
        followlinks: bool = ...
...
if sys.platform == "win32":
    ...
    def spawnlpe(mode: int, file: AnyPath, arg0: AnyPath, *args: Any) -> int:
        ...  # Imprecise signature

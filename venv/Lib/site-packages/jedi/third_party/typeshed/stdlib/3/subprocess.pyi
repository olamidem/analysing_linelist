...
from typing import IO, Any, AnyStr, Callable, Generic, Mapping, Optional, Sequence, Tuple, Type, TypeVar, Union, \
    overload
...
class TimeoutExpired(SubprocessError):
    def __init__(self, cmd: _CMD, timeout: float, output: Optional[_TXT] = ...,
...
class CalledProcessError(SubprocessError):
    ...
    def __init__(self, returncode: int, cmd: _CMD, output: Optional[_TXT] = ...,
                 stderr: Optional[_TXT] = ...) -> None: ...
...
class Popen(Generic[AnyStr]):
    ...
    def __exit__(
            self, type: Optional[Type[BaseException]], value: Optional[BaseException],

...
from typing import Any, Callable, Dict, Generic, List, Mapping, Optional, Protocol, Tuple, Type, TypeVar, Union, \
    overload
...
_Cursor = Union[
    str, Tuple[str], Tuple[str, str], Tuple[str, str, str], Tuple[str, str, str, str]]  # manual page: Tk_GetCursor
...
_XYScrollCommand = Union[
    str, Callable[[float, float], Any]]  # -xscrollcommand and -yscrollcommand in 'options' manual page
...
class DoubleVar(Variable):
    def __init__(self, master: Optional[Misc] = ..., value: Optional[float] = ...,
...
class BooleanVar(Variable):
    def __init__(self, master: Optional[Misc] = ..., value: Optional[bool] = ...,
                 name: Optional[str] = ...) -> None: ...
...
class Misc:
    ...
    @overload
    def grid_bbox(self, column: int, row: int, col2: None = ..., row2: None = ...) -> Optional[
...
class Canvas(Widget, XView, YView):
    ...
    @overload
    def tag_bind(self, tagOrId: Union[str, int], sequence: Optional[str], func: str,
...
class Text(Widget, XView, YView):
    ...
    def compare(self, index1: _TextIndex, op: Literal["<", "<=", "==", ">=", ">", "!="],
                index2: _TextIndex) -> bool: ...
    ...
    @overload
    def mark_gravity(self, markName: str,
                     direction: Literal["left", "right"]) -> None: ...  # actually returns empty string
    ...
    def replace(
            self, index1: _TextIndex, index2: _TextIndex, chars: str,
...
class Image:
    ...
    def __init__(
            self, imgtype, name: Optional[Any] = ..., cnf=..., master: Optional[Union[Misc, _tkinter.TkappType]] = ...,
            **kw
    ): ...

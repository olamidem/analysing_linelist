...
class GeneratorType:
    ...
    @overload
    def throw(
            self, __typ: Type[BaseException], __val: Union[BaseException, object] = ...,
...
class AsyncGeneratorType(Generic[_T_co, _T_contra]):
    ...
    @overload
    def athrow(self, __typ: BaseException, __val: None = ..., __tb: Optional[TracebackType] = ...) -> Awaitable[
        _T_co]: ...
...
class TracebackType:
    if sys.version_info >= (3, 7):
        def __init__(self, tb_next: Optional[TracebackType], tb_frame: FrameType, tb_lasti: int,
                     tb_lineno: int) -> None:
            ...
...
if sys.version_info >= (3, 7):
    def new_class(
            name: str, bases: Iterable[object] = ..., kwds: Dict[str, Any] = ...,

import sys
from typing import Any, AnyStr, Callable, Dict, Generic, List, Mapping, NamedTuple, Optional, Sequence, Tuple, Union, \
    overload
...
if sys.version_info >= (3, 8):
    ...
    def parse_qs(
            qs: Optional[AnyStr], keep_blank_values: bool = ..., strict_parsing: bool = ..., encoding: str = ...,
            errors: str = ...
    ) -> Dict[AnyStr, List[AnyStr]]:
        ...
...
def urlencode(
        query: Union[Mapping[Any, Any], Mapping[Any, Sequence[Any]], Sequence[Tuple[Any, Any]], Sequence[
...
def urlunparse(
        components: Tuple[
            Optional[AnyStr], Optional[AnyStr], Optional[AnyStr], Optional[AnyStr], Optional[AnyStr], Optional[AnyStr]]
) -> AnyStr: ...

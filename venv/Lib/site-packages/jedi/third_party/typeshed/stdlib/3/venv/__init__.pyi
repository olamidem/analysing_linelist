...
class EnvBuilder:
    ...
    def clear_directory(self, path: AnyPath) -> None:
        ...  # undocumented
    ...
    def symlink_or_copy(self, src: AnyPath, dst: AnyPath, relative_symlinks_ok: bool = ...) -> None:
        ...  # undocumented
...
if sys.version_info >= (3, 9):
    ...
    def create(
            env_dir: AnyPath, system_site_packages: bool = ..., clear: bool = ..., symlinks: bool = ...,
            with_pip: bool = ...
    ) -> None:
        ...

...
class Transport:
    ...
    def request(self, host: _HostType, handler: str, request_body: bytes, verbose: bool = ...) -> Tuple[
        _Marshallable, ...]:
        ...
    ...
    def send_request(self, host: _HostType, handler: str, request_body: bytes,
                     debug: bool) -> http.client.HTTPConnection:
        ...
...
class SafeTransport(Transport):
    if sys.version_info >= (3, 8):
        ...
        def __init__(self, use_datetime: bool = ..., use_builtin_types: bool = ..., *,
...
class ServerProxy:
    ...
    def __request(self, methodname: str, params: Tuple[_Marshallable, ...]) -> Tuple[_Marshallable, ...]:
        ...  # undocumented

...
class X509Extension:
    def __init__(
            self, type_name: bytes, critical: bool, value: bytes, subject: Optional[X509] = ...,
...
def load_pkcs12(buffer: Union[str, unicode],
                passphrase: Optional[Union[str, Callable[[int], int]]] = ...) -> PKCS12: ...

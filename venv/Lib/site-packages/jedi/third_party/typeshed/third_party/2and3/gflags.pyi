...
class Flag:
    ...
    def WriteInfoInXMLFormat(self, outfile: IO[str], module_name: str, is_key: bool = ...,
                             indent: str = ...) -> None: ...
...
def DEFINE_boolean(name: str, default: Optional[bool], help: str, flag_values: FlagValues = ...,
                   **args: Any) -> None: ...
...
def DEFINE_enum(
        name: str, default: Optional[str], enum_values: Iterable[str], help: str, flag_values: FlagValues = ...,
        **args: Any
) -> None: ...
...
def DEFINE_list(name: str, default: Optional[List[str]], help: str, flag_values: FlagValues = ...,
                **args: Any) -> None: ...

...
class Version(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[
        u"major", b"major", u"minor", b"minor", u"patch", b"patch", u"suffix", b"suffix"]) -> None: ...
...
class CodeGeneratorRequest(google___protobuf___message___Message):
    ...
    @property
    def proto_file(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[
    ...
    def __init__(self,
                 *,
                 ...
                 proto_file: typing___Optional[
                     typing___Iterable[google___protobuf___descriptor_pb2___FileDescriptorProto]] = None,
    ...
    def ClearField(self, field_name: typing_extensions___Literal[
        u"compiler_version", b"compiler_version", u"file_to_generate", b"file_to_generate", u"parameter", b"parameter", u"proto_file", b"proto_file"]) -> None: ...
...
class CodeGeneratorResponse(google___protobuf___message___Message):
    ...
    class _Feature(
        google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[CodeGeneratorResponse.FeatureValue]):
        ...
        def __init__(self,
                     *,
                     ...
                     generated_code_info: typing___Optional[
                         google___protobuf___descriptor_pb2___GeneratedCodeInfo] = None,
                     ) -> None: ...

        def HasField(self, field_name: typing_extensions___Literal[
            u"content", b"content", u"generated_code_info", b"generated_code_info", u"insertion_point", b"insertion_point", u"name", b"name"]) -> builtin___bool: ...

        def ClearField(self, field_name: typing_extensions___Literal[
            u"content", b"content", u"generated_code_info", b"generated_code_info", u"insertion_point", b"insertion_point", u"name", b"name"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions___Literal[
        u"error", b"error", u"supported_features", b"supported_features"]) -> builtin___bool: ...

    def ClearField(self, field_name: typing_extensions___Literal[
        u"error", b"error", u"file", b"file", u"supported_features", b"supported_features"]) -> None: ...

...
class Field(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[
        u"cardinality", b"cardinality", u"default_value", b"default_value", u"json_name", b"json_name", u"kind", b"kind", u"name", b"name", u"number", b"number", u"oneof_index", b"oneof_index", u"options", b"options", u"packed", b"packed", u"type_url", b"type_url"]) -> None: ...
...
class Enum(google___protobuf___message___Message):
    ...
    @property
    def enumvalue(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[
        type___EnumValue]: ...

...
class Environment:
    ...
    def compile(
            self, source, name: Optional[Any] = ..., filename: Optional[Any] = ..., raw: bool = ...,
            defer_init: bool = ...
    ): ...
    ...
    def handle_exception(self, exc_info: Optional[Any] = ..., rendered: bool = ...,
    ...
    def select_template(
            self, names: Sequence[Union[Template, Text]], parent: Optional[Text] = ...,

...
class PortScanner(object):
    ...
    def scan(self, hosts: Text = ..., ports: Optional[Text] = ..., arguments: Text = ...,
             sudo: bool = ...) -> _Result: ...
...
def __scan_progressive__(self, hosts: Text, ports: Text, arguments: Text, callback: Optional[_Callback],
                         sudo: bool) -> None: ...

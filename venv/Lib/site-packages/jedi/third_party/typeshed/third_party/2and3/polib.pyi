...
class _BaseFile(List[_TB]):
    ...
    def find(self, st: Text, by: str = ..., include_obsolete_entries: bool = ..., msgctxt: bool = ...) -> Optional[
        _TB]: ...
...
class MOFile(_BaseFile):
    ...
    def save(self,
             fpath: Optional[Text] = ...) -> None: ...  # type: ignore # binary file does not allow argument repr_method

...
class Model(metaclass=MetaModel):
    ...
    def delete(self, condition: Optional[Any] = ..., conditional_operator: Optional[Text] = ...,
               **expected_values) -> Any: ...
    ...
    @classmethod
    def get(cls: Type[_T], hash_key: KeyType, range_key: Optional[KeyType] = ...,
            consistent_read: bool = ...) -> _T: ...
    ...
    @classmethod
    def create_table(
            cls: Type[_T], wait: bool = ..., read_capacity_units: Optional[Any] = ...,

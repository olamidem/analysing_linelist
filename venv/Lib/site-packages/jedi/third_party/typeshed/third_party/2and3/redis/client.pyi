...
class Redis(Generic[_StrType]):
    ...
    def blpop(self, keys: Union[_Value, Iterable[_Value]], timeout: int = ...) -> Optional[
        Tuple[_StrType, _StrType]]: ...

    def brpop(self, keys: Union[_Value, Iterable[_Value]], timeout: int = ...) -> Optional[
        Tuple[_StrType, _StrType]]: ...
    ...
    def scan(self, cursor: int = ..., match: Optional[_Key] = ..., count: Optional[int] = ...) -> Tuple[
        int, List[_StrType]]: ...

    def scan_iter(self, match: Optional[Text] = ..., count: Optional[int] = ...) -> Iterator[_StrType]: ...

    def sscan(self, name: _Key, cursor: int = ..., match: Text = ..., count: int = ...) -> Tuple[
        int, List[_StrType]]: ...
    ...
    def zadd(
            self, name: _Key, mapping: Mapping[_Key, _Value], nx: bool = ..., xx: bool = ..., ch: bool = ...,
            incr: bool = ...
    ) -> int: ...
    ...
    def hset(
            self, name: _Key, key: Optional[_Key], value: Optional[_Value],

...
class SSLConnection(Connection):
    ...
    def __init__(
            self, ssl_keyfile=..., ssl_certfile=..., ssl_cert_reqs=..., ssl_ca_certs=...,
            ssl_check_hostname: bool = ..., **kwargs
    ) -> None: ...
...
class ConnectionPool:
    @classmethod
    def from_url(cls, url: Text, db: Optional[int] = ..., decode_components: bool = ...,
...
class BlockingConnectionPool(ConnectionPool):
    ...
    def __init__(self, max_connections=..., timeout=..., connection_class=..., queue_class=...,

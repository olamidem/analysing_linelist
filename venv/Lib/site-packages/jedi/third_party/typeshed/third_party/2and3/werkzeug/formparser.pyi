...
class _StreamFactory(Protocol):
    def __call__(
            self, total_content_length: Optional[int], filename: str, content_type: str,
...
class FormDataParser(object):
    ...
    def parse(
            self, stream: IO[bytes], mimetype: Text, content_length: Optional[int],
...
class MultiPartParser(object):
    ...
    def parse_parts(self, file: Any, boundary: bytes, content_length: int) -> Generator[

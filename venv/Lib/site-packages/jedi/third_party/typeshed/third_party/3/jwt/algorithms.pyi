...
class RSAAlgorithm(Algorithm[Any]):
    ...
    def prepare_key(self, key: Union[bytes, str, RSAPrivateKey, RSAPublicKey]) -> Union[
...
class ECAlgorithm(Algorithm[Any]):
    ...
    @staticmethod
    def to_jwk(key_obj: Union[
        EllipticCurvePrivateKeyWithSerialization, EllipticCurvePublicKeyWithSerialization]) -> str: ...

...
from typing import IO, Any, Callable, Dict, Generator, Iterable, List, Optional, Sequence, Set, Tuple, TypeVar, Union, \
    overload
...
class WorkingSet:
    ...
    def resolve(
            self, requirements: Iterable[Requirement], env: Optional[Environment] = ...,
...
class EntryPoint:
    ...
    @classmethod
    def parse_map(
            cls, data: Union[Dict[str, Union[str, Sequence[str]]], str, Sequence[str]],
            dist: Optional[Distribution] = ...
    ) -> Dict[str, EntryPoint]: ...
...
def register_loader_type(loader_type: type,
                         provider_factory: Callable[[types.ModuleType], IResourceProvider]) -> None: ...

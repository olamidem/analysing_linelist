...
class NotebookWebApplication(web.Application):
    ...
    watch and build the notebook's JavaScript for you, as you make changes."""
        ...
        if jupyter_app.ignore_minified_js:
            ...
            log.warning(
                _("""Alternatively use `%s` when working on the notebook's Javascript and LESS""") % 'npm run build:watch')
            warnings.warn(_("The `ignore_minified_js` flag is deprecated and will be removed in Notebook 6.0"),
                          DeprecationWarning)
...
class NotebookApp(JupyterApp):
    ...
    trust_xheaders = Bool(False, config=True,
                          help=(
                              _("Whether to trust or not X-Scheme/X-Forwarded-Proto and X-Real-Ip/X-Forwarded-For headers "

...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    ,
    dependencies=[streamlit_dot_proto_dot_Block__pb2.DESCRIPTOR, streamlit_dot_proto_dot_Element__pb2.DESCRIPTOR,
                  streamlit_dot_proto_dot_NamedDataSet__pb2.DESCRIPTOR,
                  streamlit_dot_proto_dot_ArrowNamedDataSet__pb2.DESCRIPTOR, ])

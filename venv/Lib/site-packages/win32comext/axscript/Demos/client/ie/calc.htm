                    ...
                    <CAPTION ALIGN=top><b>Calculator</b>
                        <p> </CAPTION>
                            ...
                            <TR>
                                ...
                                <TD></TD>
                                <TD ALIGN=MIDDLE><INPUT NAME="Plus" OnClick="Operation('+', lambda x,y: x+y)"
                                                        TYPE="Button" VALUE="  +  "></TD>
                                <TD ALIGN=MIDDLE><INPUT NAME="Minus" OnClick="Operation('-', lambda x,y: x-y)"
                                                        TYPE="Button" VALUE="   -   "></TD>
                            </TR>
                            <TR>
                                ...
                                <TD></TD>
                                <TD ALIGN=MIDDLE><INPUT NAME="Multiply" OnClick="Operation('*', lambda x,y: x*y)"
                                                        TYPE="Button" VALUE="  *  "></TD>
                                <TD ALIGN=MIDDLE><INPUT NAME="Divide" OnClick="Operation('/', lambda x,y: x/y)"
                                                        TYPE="Button" VALUE="   /   "></TD>
                            </TR>
                            <TR>
